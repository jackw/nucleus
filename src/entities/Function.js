...
var SassFunction = function(raw) {
  // Call parent constructor
  Entity.call(this, raw);

  // Set mixin-specific entity properties
  this.type = "Function";
  this.fillable = ['function', 'param', 'section', 'description', 'example', 'deprecated'];
  ...
  return {
    ...
    section: 'Nuclides > Functions > ' + this.getSection(),
...
SassFunction.prototype = Object.create(Entity.prototype);
 ...
 * @return {object}
 */
SassFunction.prototype.getParameters = function() {
  var parameters = [];
 ...
 * @return {object}
 */
SassFunction.prototype.getParameter = function( parameterString ) {
...
SassFunction.prototype.getExample = function() {
